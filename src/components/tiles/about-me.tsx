...
export function AboutMe() {
    return (
        <>
            <CardContent className="px-10 size-full flex flex-col items-start justify-end overflow-hidden gap-6">
                ...
                <p className="leading-[26px]">
                    ...
                    interested in React, Node, Product Design, Jamstack,
                ...
                >
                    <RefreshCcw className="rotate-180 size-3" />
